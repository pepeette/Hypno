...
class InvestmentSection:
    ...
    def render(self):
        ...
        with col1:
            ...
            if st.button("Select standard program", type="primary", width='stretch', key="standard_pkg"):
                self._select_package("Standard neuroplasticity program (฿3,000) - Sessions 1 + 2")
        ...
        with col2:
            ...
            if st.button("Select complete transformation", width='stretch', key="complete_pkg"):
                self._select_package("Complete neural transformation (฿4,000) - Sessions 1 + 2 + 3")
