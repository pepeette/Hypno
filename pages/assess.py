...
class AdaptiveBehavioralAssessment:
        ...
        return {
            ...
            11: {
                ...
                "options": [
                    ...
                    "Compulsive action or repetition",
            ...
            18: {
                ...
                "options": [
                    ...
                    "Immediate search for what could go wrong",
            ...
            19: {
                ...
                "options": [
                    "Calm and regulated",
                    "Fight response - tension and aggression",
                    "Flight response - urge to escape",
                    "Freeze response - numbness and shutdown",
                    "Fawn response - people-pleasing and compliance"
                ],
            ...
            20: {
                ...
                "options": [
                    ...
                    "Probably judging or criticizing me",
                    "Wanting something or likely to use me",
                    "Will reject me once they see my flaws",
                    "Indifferent or uninterested in me"
                ],
            ...
            21: {
                ...
                "type": "single_choice",
                "options": [
                    "Multiple creative options are available",
                    "Trapped between impossible either/or options",
                    "Only two extreme alternatives exist",
            ...
            23: {
                ...
                "options": [
                    ...
                    "Professional versus personal settings",
                    "Whether I'm in control or following",
                    "My emotional state in the moment"
                ],
    ...
    def _get_adaptive_question_pools(self):
        """Advanced adaptive questioning based on pattern detection"""
        return {
            "unhappiness_deep": {
                27: {
        ...
        return {
            "crisis_assessment": {
                36: {
                    ...
                    "type": "single_choice",
                    "options": [
                        "Reach out to multiple supportive people",
                        "Contact one trusted person",
                        "Try to handle it alone first",
                        "Not feel comfortable bothering anyone",
            ...
            "safety_planning": {
                37: {
                    "text": "Do you have a safety plan for managing intense emotions?",
                    "type": "single_choice",
                    "options": [
                        "Yes, a comprehensive plan I use regularly",
                        "Some strategies I can use when needed",
                        "I know what to do but rarely implement it",
                        "No specific plan but I manage somehow",
    ...
    def _get_hypnotic_responsiveness_questions(self):
        """Hypnotic susceptibility and preference assessment"""
        return {
            "hypnotic_profile": {
                38: {
            ...
            "trance_experience": {
                39: {
                    "text": "Have you experienced hypnotic states before?",
                    "type": "single_choice",
                    "options": [
