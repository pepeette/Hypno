...
Clean, minimal design following styling.py guidelines with no clinical insights shown to user
"""
import streamlit as st
from datetime import datetime
import re
...
class AdaptiveBehavioralAssessment:
    """Mobile-optimized behavioral pattern assessment with clean UX"""
    ...
    def _get_core_questions(self):
        """Core questions with clean, mobile-friendly options"""
        return {
            1: {
                "text": "When something genuinely wonderful happens to you, your first thought is usually:",
                "type": "single_choice",
